...
<section id="container" class="">
    ...
    <section id="main-content">
        <section class="wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-files-o"></i> New Department</h3>
                    <ol class="breadcrumb">
                            ...
                            <div class="form">
                                <form class="form-validate form-horizontal" id="feedback_form" method="get" action="">
                                    ...
                                    <div class="form-group ">
                                        <div class="col-lg-6">
                                        <label for="cname" class="control-label col-lg-2">Department Name <span class="required">*</span></label>
                                        <div class="col-lg-10">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <label for="cname" class="control-label col-lg-2">Department's Head </label>
                                        <div class="col-lg-10">
                                            <input class="form-control" id="cname" name="fullname"  type="text" required />
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-2">Department Details</label>
                                            <div class="col-sm-10">
                                    ...
                                    <div class="form-group">
                                       <div class="col-lg-6">
                                        <label class="control-label col-lg-2" for="inputSuccess">Department Status</label>
